      ...
      <VStack className="max-w-[440px] w-full" space="md">
        <VStack className="md:items-center" space="md">
          <Heading className="text-center" size="3xl">
            Cup of Sugar Privacy
          </Heading>
          <Text className="text-center">Cup of Sugar does its best to maintain your data securly and privately</Text>
          ...
          <Text className="text-center">If you have questions, contact: info@cup-of-sugar.com</Text>
